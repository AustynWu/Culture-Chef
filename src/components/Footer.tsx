        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col justify-between xl:flex-row">
            ...
            <div className=" flex-1 grid grid-cols-1 xl:grid-cols-3 gap-[50px] mb-8 xl:mb-16">
              {/* Exteral Link */}
              <div>
                <h4 className="font-semibold mb-5">Exteral Link</h4>
                <ul className="flex flex-col gap-y-6 text-sm">
                  <li>
                    <Link href="/">
                      collabrate inviation{" "}
                    </Link>
                  </li>
              ...
              <div>
                {" "}
                <h4 className="font-semibold mb-5">Memoriable tasty</h4>
                <ul className="flex flex-col gap-y-6 text-sm">
                  <li>
                    <Link href="/">
                      find your home flaver{" "}
                    </Link>
                  </li>
                </ul>
              </div>
          ...
          <div className=" py-4 border-t border-white/10">
            <p className="text-white/60 text-center text-sm">
              {" "}
              Copyright &copy; culture-cheif 2025
            </p>
          </div>
        </div>
      </motion.section>
