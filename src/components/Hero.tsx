      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center xl:h-[960px]">
          ...
          <div className="w-full xl:max-w-[460px] text-center xl:text-left">
            ...
            >
              <span className="text-orange"> From our kitchens to your table</span>
            </motion.p> 
            <motion.p
              variants={fadeIn("down", 0.1)}
              initial="hidden"
            ...
            >
              Bring world kitchens home. Compare menus, talk to chefs about your needs, and reserve with simple, upfront pricing.
            </motion.p> 
            <motion.div
              variants={fadeIn("down", 0.1)}
              initial="hidden"
